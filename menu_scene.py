...
class MenuScene(Scene):
    ...
    def __init__(self, manager: SceneManager) -> None:
        ...
        self.buttons = {
            "start":    Button(bx, start_y,       text="Start Game", width=bw, height=bh),
            "settings": Button(bx, start_y + 80,  text="Settings",   width=bw, height=bh, enabled=False),
            "quit":     Button(bx, start_y + 160, text="Quit",       width=bw, height=bh),
        }
