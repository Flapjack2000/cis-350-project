...
class audioPlayer:
    def __init__(self):
        ...
        self.menu_music = "assets/music/main-menu.ogg"
        self.game_music = "assets/music/lofi-trimmed-faded.ogg"
        ...
        self.sounds = {
            ...
            "RattlesnakeHabitat": ["Snake_Hiss1.ogg", "Snake_Hiss2.ogg", "Snake_Rattle.ogg"],
            "TigerHabitat": ["TigerGrowl1.ogg", "TigerGrowl2.ogg"],
            "ZebraHabitat": ["Zebra_Annoyed.ogg", "Zebra_Anxious.ogg", "Zebra_Casual.ogg"],
