...
class ChecklistScene(Scene):
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        header_surf = font_header.render(
            f"Day {self.__checklist.day_count} : {phase} Tasks", True, (80, 40, 20)
        )
        header_padding = 10
        header_rect = pygame.Rect(panel_x, pad, self.TASK_WIDTH, header_surf.get_height() + header_padding * 2)
        ...
        for task_name, done in ordered_tasks:
            ...
            if done:
                ...
                pygame.draw.line(screen, (110, 70, 40),
